...
const navItems=[["NCC 앱","app.html","app","nav-home"],["HOME","index.html","home","nav-home"],["혜택센터","benefits.html","benefits","nav-priority"],["공동구매","groupbuy.html","groupbuy","nav-priority"],["소비자채널","consumer-channel.html","channel","nav-priority"],["전국소비자센터","centers.html","centers","nav-secondary nav-secondary-start"],["파트너센터","partner-center.html","partners","nav-secondary"]];
