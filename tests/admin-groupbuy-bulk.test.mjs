...
test("bulk export and sharing are available without leaking credentials",()=>{assert.match(js,/NCC_공동구매_/);assert.match(js,/navigator\.share/);assert.match(js,/navigator\.clipboard\.writeText/)});
